<template>
    <body class="welcome">
        ...
        <section class="welcome__presentation">
            ...
            <p>N’hésitez pas à explorer, et contactez-moi si vous avez des questions ou souhaitez collaborer.</p>
            <p>Bonne visite !</p>
        </section>
    </body>
</template>
